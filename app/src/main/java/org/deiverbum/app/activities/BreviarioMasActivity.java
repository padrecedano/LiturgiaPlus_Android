...
import static org.deiverbum.app.utils.Constants.URL_BREVIARIO_MAS;
...
public class BreviarioMasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringRequest sRequest = new StringRequest(Request.Method.GET, URL_BREVIARIO_MAS + strFechaHoy,
