...
import static org.deiverbum.app.utils.Constants.MAGNIFICAT;
...
public class VisperasActivity extends AppCompatActivity {
    ...
    protected String getResponseData(JSONObject jsonDatos) {
        ...
        try {
            ...
            sb.append(SEPARADOR);
            sb.append("<h3>invocación inicial</h3>");

            sb.append("<p>" + SALUDO_DIOSMIO + "</p>");
            ...
            sb.append(utilClass.getFormato(MAGNIFICAT));
            sb.append(FIN_SALMO);
            sb.append(sAntifonaCE);
            sb.append(SEPARADOR);
