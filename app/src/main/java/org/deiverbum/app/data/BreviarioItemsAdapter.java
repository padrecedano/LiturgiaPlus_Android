...
public class BreviarioItemsAdapter extends RecyclerView.Adapter<BreviarioItemsAdapter.MyViewHolder> {

    private Context mContext;
    private List<MainItem> albumList;
    private BreviarioItemsAdapter.ItemListener mListener;

    public BreviarioItemsAdapter(Context mContext, List<MainItem> albumList, BreviarioItemsAdapter.ItemListener itemListener) {
