...
public class BreviarioRecyclerAdapter extends RecyclerView.Adapter<BreviarioRecyclerAdapter.ViewHolder> {
    ...
    public BreviarioRecyclerAdapter(Context context, ArrayList<BreviarioDataModel> values, ItemListener itemListener) {
    ...
    public BreviarioRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.rv_breviario_items, parent, false);
